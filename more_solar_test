...
planet_font = ("Cambria", 35) 

def update_fonts():
    global font_size, font_family
...
font_menu.add_command(label="Arial", command=lambda: set_font("Arial", current_font_size))
font_menu.add_command(label="Cambria", command=lambda: set_font("Cambria", current_font_size))
font_menu.add_command(label="Cousine", command=cousine)
font_menu.add_command(label="Spectral", command=spectral)
font_menu.add_command(label="Helvetica", command=helvetica)
font_menu.add_command(label="Calirbi", command=calibri)
