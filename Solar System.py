...
def select_view():
    ...
    select_view_label = CTkLabel(select_view_frame, text="Would You like to view?", text_color= "Black", font=font_style)
...
def sequential_view(): 
    ...
    sun_title_label = CTkLabel(sun_view_frame, text="SUN", text_color= "Black", font=font_style)
...
def orbit_view():
    ...
    orbit_view_label = CTkLabel(orbit_view_frame, text="Where would you like to go?", text_color= "Black", font=font_style)
